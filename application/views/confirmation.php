...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="/welcome/dashboard">About</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div>
        <a href="/products/product"><button>Continue Shopping!</button></a>
    </div>
    <div id = "wrapper">
        <h3>Confirmation</h3>
        <p>Thank you for your order, (echo name)! Your order details are below.</p>
        <div id = "orderinfo">TROLOLOL</div>
        <p id = "shippinginfo">Shipping Address: (echo shipping address)</p>
        <a href = "#">Contact Us |</a>
