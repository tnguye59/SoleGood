        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    <a id='men_sport' href="#" class="list-group-item">Sport</a>
                    <a id='men_casual'href="#" class="list-group-item">Casual</a>
                    <a id='men_dress' href="#" class="list-group-item">Dress</a>
                </div>
            </div>
            <!-- Content Column -->
    <div class="container">
