...
<head>
   ...
   <script type="text/javascript">
    $(document).ready(function() {
        $("#girls_sport").click(function(){
            $.get("/products/sports_girls_html", function (res) {
              $("#products").html(res);
            });
            return false;
        });
        $("#girls_casual").click(function(){
            $.get("/products/casual_girls_html", function (res) {
              $("#products").html(res);
            });
            return false;
        });
        $("#girls_dress").click(function(){
            $.get("/products/dress_girls_html", function (res) {
              $("#products").html(res);
            });
            return false;
        });
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">GIRLS SHOES</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                  <a id='girls_sport' href="#" class="list-group-item">Sport</a>
                  <a id='girls_casual'href="#" class="list-group-item">Casual</a>
                  <a id='girls_dress' href="#" class="list-group-item">Dress</a>
                </div>
            </div>
            <!-- Content Column -->
    <div class="container">
